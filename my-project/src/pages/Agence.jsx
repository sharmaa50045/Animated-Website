      ...
      <div id='page1' className='py-1'>
        ...
        <div className='relative font-[font2]'>
          ...
          <div className='lg:mt-[72vh] mt-[20vh]'>
            <h1 className='text-[14vw] text-center uppercase leading-[14vw] text-black'>
              <b>卂卂ᗪ丨ㄒㄚ卂</b> <br />
              <b> 丂卄卂尺爪卂</b>
            </h1>
          </div>
          ...
          <div className='lg:pl-[40%] lg:mt-20 mt-4 p-3'>
            <p className='lg:text-4xl text-xl leading-tight text-black'>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <b> Notre curiosité nourrit notre créativité. On reste humbles et on dit non aux gros egos, même le vôtre.
                ...
                C’est pour ça qu’on s’engage à donner de la perspective, pour bâtir des marques influentes.</b>
            </p>
          </div>
